...
import 'package:flutter_application_18/components/color.dart';
import 'package:flutter_application_18/components/spacing.dart';
import 'package:flutter_application_18/components/text.dart';
import 'package:flutter_application_18/components/typography.dart';
import 'package:flutter_application_18/pages/pages.dart';
  ...
  Widget build(BuildContext context) {
    return OutlinedButton(
      ...
      style: ButtonStyle(
        ...
        padding: WidgetStateProperty.all<EdgeInsetsGeometry>(const EdgeInsets.symmetric(horizontal: 12, vertical: 16)),
      ),
      child: const Text(
        "READ MORE",
      ),
      ...
      children: [
        Row(
          children: [
            ...
            if (ResponsiveBreakpoints.of(context).largerThan(MOBILE)) Text("NEWER POSTS", style: buttonTextStyle),
          ],
        ),
        const Spacer(),
        Row(
          children: [
            if (ResponsiveBreakpoints.of(context).largerThan(MOBILE)) Text("OLDER POSTS", style: buttonTextStyle),
            const Icon(
              Icons.keyboard_arrow_right,
              size: 25,
              color: textSecondary,
...
class ListItem extends StatelessWidget {
  ...
  const ListItem({super.key, required this.title, this.imageUrl, this.description});
          ...
          child: Row(
            children: [
              InkWell(
                ...
                onTap: () =>
                    Navigator.pushNamedAndRemoveUntil(context, Navigator.defaultRouteName, ModalRoute.withName(Navigator.defaultRouteName)),
                child: Text("MINIMAL",
                  ...
                  child: Container(
                    ...
                    child: Wrap(
                      children: [
                        ...
                        TextButton(
                          onPressed: () => Navigator.pushNamed(context, TypographyPage.name),
                          style: menuButtonStyle,
                          child: const Text(
                            "STYLE",
                          ),
