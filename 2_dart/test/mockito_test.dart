...
void main() {
  ...
  test('Argument matchers', () {
    ...
    cat.hunt('backyard', null);
    verify(cat.hunt(argThat(contains('yard')), argThat(isNull))); // OK: null is wrapped in an arg matcher.
  });
  ...
  test('Verification in order', () {
    ...
    cat.eatFood('Milk');
    cat.sound();
    verifyInOrder([cat.eatFood('Milk'), cat.sound()]);
  });
